...
import { useGetSingleQueueQuery } from "@/state/queueSlice";
...
const QueueDetail = () => {
  ...
  const [updateQueueMutation, { error: errorsAPI }] =
    useUpdateQueueAgencyMutation();
  ...
  const onSubmit = async (formData: FormData) => {
    try {
      const payload = {
        ...
        id_layanan: data.data.id_layanan.toString(),
  ...
  if (isLoadingQueue || isLoadingEducations || isLoadingJobs) {
